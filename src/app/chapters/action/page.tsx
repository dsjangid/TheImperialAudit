...
<p className="font-mono text-[13px] uppercase tracking-[0.25em] text-text/40 mb-4">CHAPTER 05</p>
<h1 
...
<aside className="md:col-start-10 md:col-span-3 font-mono text-[13px] text-text/40 uppercase tracking-[0.1em] leading-[1.9] space-y-4 pt-12 md:pt-0 flex flex-col justify-end pb-4">
...
<p className="font-mono text-[13px] uppercase tracking-[0.2em] text-text/40 mb-6">05.0 / ARCHIVAL PHOTOGRAPHS
</p>
...
<p className="font-mono text-[13px] uppercase tracking-[0.15em] text-text/40">{img.yr}</p>
...
<section>
<p className="font-mono text-[13px] uppercase tracking-[0.2em] text-text/40 mb-6">SECTION 1: THE REGIONAL INCIDENT EXPLORER</p>
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
 
 {/* Bengal */}
<div className="p-6 border border-text/15 space-y-3">
<p className="font-mono text-[13px] uppercase tracking-[0.2em] text-[#FF0000] mb-3">REGION</p>
...
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">23 June 1757 · Battle of Plassey</p>
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">1770 · Bengal Famine (<span className="text-accent font-bold">est. 7-10 million dead</span>)</p>
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">1859-60 · Indigo Revolt (nil-vidroh)</p>
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">1905 · Partition of Bengal</p>
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">1943 · Bengal Famine (<span className="text-accent font-bold">est. 2-3 million dead</span>)</p>
</div>
</div>
...
<div className="space-y-2 mt-4">
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">1845-46 · First Anglo-Sikh War</p>
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">1848-49 · Second Anglo-Sikh War & Annexation</p>
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]"><span className="text-accent font-semibold">13 April 1919 · Jallianwala Bagh Massacre</span></p>
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">1929-31 · Lahore Conspiracy Case (Bhagat Singh)</p>
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">1947 · Partition massacres</p>
</div>
</div>
...
<div className="space-y-2 mt-4">
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]"><span className="text-accent font-semibold">10 May 1857 · Meerut Mutiny</span></p>
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">June-July 1857 · Kanpur Siege & Bibighar</p>
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">June 1857-March 1858 · Lucknow Siege</p>
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">4 February 1922 · Chauri Chaura</p>
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">9 August 1925 · Kakori Train Action</p>
</div>
</div>
...
<div className="space-y-2 mt-4">
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">1817 · Paika Rebellion (Bakshi Jagabandhu)</p>
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">1827-1864 · Veer Surendra Sai resistance</p>
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">1866 · Great Orissa Famine</p>
</div>
</div>
...
<div className="space-y-2 mt-4">
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">1817-18 · Anglo-Maratha Wars (Third)</p>
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">1875 · Deccan Riots</p>
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">1897 · Chapekar Brothers: assassination of Rand</p>
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">1930 · Sholapur Uprising</p>
</div>
</div>
...
<div className="space-y-2 mt-4">
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">1799 · Polygar Wars: Kattabomman hanged</p>
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">1806 · Vellore Mutiny</p>
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">1908 · Tuticorin Mill Strike (VOC)</p>
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">1930 · Vedaranyam Salt Satyagraha</p>
</div>
</div>
...
<div className="space-y-2 mt-4">
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">1793-1805 · Pazhassi Raja guerrilla war</p>
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">1921 · Malabar Rebellion</p>
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">1921 · Wagon Tragedy (64 prisoners suffocated)</p>
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">1924-25 · Vaikom Satyagraha</p>
</div>
</div>
...
<div className="space-y-2 mt-4">
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">1918 · Kheda Satyagraha</p>
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">12 March-6 April 1930 · Dandi Salt March</p>
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">May 1930 · Dharasana Salt Works raid</p>
</div>
</div>
...
<div className="space-y-2 mt-4">
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">1829-33 · Anglo-Khasi War (U Tirot Sing)</p>
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">1894 · Patharughat Peasant Massacre</p>
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">1942 · Kanaklata Barua (17-year-old martyr)</p>
</div>
</div>
...
<div className="space-y-2 mt-4">
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">1929-47 · Khan Abdul Ghaffar Khan & Khudai Khidmatgar</p>
<p className="font-mono text-[13px] text-text/60 uppercase tracking-[0.1em]">23 April 1930 · Qissa Khwani Bazaar Massacre (est. 200-400 killed)</p>
</div>
</div>
...
<section>
<p className="font-mono text-[13px] uppercase tracking-[0.2em] text-text/40 mb-6">SECTION 2: INCIDENT CATEGORIES</p>
<div className="grid grid-cols-2 md:grid-cols-3 gap-4">
 
<div className="p-4 border border-text/15">
<p className="font-mono text-[13px] text-[#FF0000] uppercase tracking-[0.15em]">12 INCIDENTS</p>
<p className="font-serif text-[18px] font-bold mt-1">CONQUEST</p>
<p className="font-mono text-[13px] text-text/45 mt-2 uppercase tracking-[0.1em]">First contact, annexations, wars of expansion</p>
</div>

<div className="p-4 border border-text/15">
<p className="font-mono text-[13px] text-[#FF0000] uppercase tracking-[0.15em]">23 INCIDENTS</p>
<p className="font-serif text-[18px] font-bold mt-1">REBELLION</p>
<p className="font-mono text-[13px] text-text/45 mt-2 uppercase tracking-[0.1em]">Armed uprisings against Company or Crown</p>
</div>

<div className="p-4 border border-text/15">
<p className="font-mono text-[13px] text-[#FF0000] uppercase tracking-[0.15em]">18 INCIDENTS</p>
<p className="font-serif text-[18px] font-bold mt-1">TRIBAL RESISTANCE</p>
<p className="font-mono text-[13px] text-text/45 mt-2 uppercase tracking-[0.1em]">Adivasi and forest community uprisings</p>
</div>

<div className="p-4 border border-text/15">
<p className="font-mono text-[13px] text-[#FF0000] uppercase tracking-[0.15em]">9 INCIDENTS</p>
<p className="font-serif text-[18px] font-bold mt-1">PEASANT MOVEMENT</p>
<p className="font-mono text-[13px] text-text/45 mt-2 uppercase tracking-[0.1em]">Agrarian protest and tenant revolts</p>
</div>

<div className="p-4 border border-text/15">
<p className="font-mono text-[13px] text-[#FF0000] uppercase tracking-[0.15em]">6 INCIDENTS</p>
<p className="font-serif text-[18px] font-bold mt-1">LABOUR</p>
<p className="font-mono text-[13px] text-text/45 mt-2 uppercase tracking-[0.1em]">Industrial and plantation worker resistance</p>
</div>

<div className="p-4 border border-text/15">
<p className="font-mono text-[13px] text-[#FF0000] uppercase tracking-[0.15em]">14 INCIDENTS</p>
<p className="font-serif text-[18px] font-bold mt-1">REVOLUTIONARY</p>
<p className="font-mono text-[13px] text-text/45 mt-2 uppercase tracking-[0.1em]">Underground networks, bombings, assassinations</p>
</div>

<div className="p-4 border border-text/15">
<p className="font-mono text-[13px] text-[#FF0000] uppercase tracking-[0.15em]">8 INCIDENTS</p>
<p className="font-serif text-[18px] font-bold mt-1">FAMINE</p>
<p className="font-mono text-[13px] text-text/45 mt-2 uppercase tracking-[0.1em]">Documented colonial-era famines with policy dimensions</p>
</div>

<div className="p-4 border border-text/15">
<p className="font-mono text-[13px] text-[#FF0000] uppercase tracking-[0.15em]">11 INCIDENTS</p>
<p className="font-serif text-[18px] font-bold mt-1">COLONIAL REPRESSION</p>
<p className="font-mono text-[13px] text-text/45 mt-2 uppercase tracking-[0.1em]">Official violence against civilians</p>
</div>

<div className="p-4 border border-text/15">
<p className="font-mono text-[13px] text-[#FF0000] uppercase tracking-[0.15em]">7 INCIDENTS</p>
<p className="font-serif text-[18px] font-bold mt-1">CONSTITUTIONAL</p>
<p className="font-mono text-[13px] text-text/45 mt-2 uppercase tracking-[0.1em]">Law, policy, elections</p>
</div>
...
<section>
<p className="font-mono text-[13px] uppercase tracking-[0.2em] text-text/40 mb-6">SECTION 3: SOURCES REGISTRY</p>
...
<span className="font-mono text-[13px] text-[#FF0000] uppercase tracking-[0.2em]">{src.verifiedStatus}</span>
<span className="font-mono text-[13px] opacity-40 group-hover:opacity-100 transition-opacity">↗</span>
</div>
...
<div className="md:col-span-8 space-y-6 font-serif text-[17px] leading-[1.75] text-text/85">
<p className="font-mono text-[13px] uppercase tracking-[0.2em] text-text/40 mb-6">SECTION 4: A NOTE ON HISTORIOGRAPHY</p>
<p>
...
<Link href="/en" className="font-mono text-[13px] uppercase tracking-[0.2em] text-text/40 hover:text-text transition-colors">
 ↑ HOME
</Link>
</div>
