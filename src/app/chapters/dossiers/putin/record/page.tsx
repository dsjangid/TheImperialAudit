...
<li className="border-l border-text/20 pl-6">
<strong className="block font-mono text-[13px] text-accent uppercase tracking-[0.2em]">Август 2008</strong>
<strong>Война в Грузии:</strong>Ввод войск и признание независимости Южной Осетии и Абхазии.
</li>
<li className="border-l border-text/20 pl-6">
<strong className="block font-mono text-[13px] text-accent uppercase tracking-[0.2em]">2014: н.в.</strong>
...
<strong className="block font-mono text-[13px] text-accent uppercase tracking-[0.2em] font-bold">2022: н.в.</strong>
