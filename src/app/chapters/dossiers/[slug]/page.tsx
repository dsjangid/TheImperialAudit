...
<p className="font-mono text-[10px] uppercase tracking-[0.2em] text-text/40 mb-6">МЕТАДАННЫЕ ДЕЛА
</p>
...
<p className="font-mono text-[10px] uppercase tracking-[0.2em] text-text/40 mb-6">БИОГРАФИЯ · КОНТЕКСТ · АКТИВЫ
</p>
<h2
...
<p className="font-mono text-[10px] uppercase tracking-[0.3em] text-text/40 mb-16 text-center">ВСЕ ФИГУРАНТЫ
</p>
