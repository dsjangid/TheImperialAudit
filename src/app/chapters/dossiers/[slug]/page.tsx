...
<p className="font-mono text-[13px] uppercase tracking-[0.2em] text-text/40 mb-6">МЕТАДАННЫЕ ДЕЛА
</p>
...
<p className="font-mono text-[13px] uppercase tracking-[0.2em] text-text/40 mb-6">БИОГРАФИЯ · КОНТЕКСТ · АКТИВЫ
</p>
<h2
...
<p className="font-mono text-[13px] uppercase tracking-[0.3em] text-text/40 mb-16 text-center">ВСЕ ФИГУРАНТЫ
</p>
...
<Link
 ...
 data-cursor="accent"
 >
<span className="font-mono text-[13px] text-accent uppercase">ДЕЛО № 03 / {d.fileNo}</span>
<h4 className="font-serif text-[20px] font-bold mt-2 group-hover:text-accent transition-colors">
 {d.name.ru}
</h4>
<p className="font-mono text-[13px] text-text/50 mt-1 uppercase truncate">{d.role.ru}</p>
</Link>
 ))}
</div>
</section>
