...
<strong className="block font-mono text-[13px] text-accent uppercase tracking-[0.2em]">1999: 2009</strong>
...
<li className="border-l border-text/20 pl-6">
<strong className="block font-mono text-[13px] text-accent uppercase tracking-[0.2em]">August 2008</strong>
...
<li className="border-l border-text/20 pl-6">
<strong className="block font-mono text-[13px] text-accent uppercase tracking-[0.2em]">2014: Present</strong>
...
<strong className="block font-mono text-[13px] text-accent uppercase tracking-[0.2em] font-bold">2022: Present</strong>
