...
<div>
<label className="block font-mono text-[13px] uppercase tracking-[0.2em] text-text/50 mb-3">
...
<p className="font-mono text-[13px] uppercase tracking-[0.2em] text-accent mb-2">
...
<p className="font-mono text-[13px] text-text/50 mt-2">
...
<p className="font-mono text-[13px] uppercase tracking-[0.2em] text-text/60 mb-2">
...
<div className="mt-8 font-mono text-[13px] text-text/40 leading-relaxed">
 {lang === 'ru'
